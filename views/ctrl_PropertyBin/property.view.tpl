{if $property_dict}
	<li class="span4 property-bin-item{if !$property_dict.latitude || $property_dict.latitude == 0 || $property_dict.latitude == '' || !$property_dict.longitude || $property_dict.longitude == 0 || $property_dict.longitude == ''} property-bin-no-tour{/if}" id="bin-item-{$property_dict.company_property_id}">
		<div class="standard-property property-bin-item-inner">
			...
			<div class="prop-cta clearfix">
				<a href="/property/property_details_quick_view/{$property_dict.company_property_id}" data-fancybox-type="iframe" data-fancybox-width="800" data-fancybox-height="400" class="fancybox btn btn-mini">
					Quick View
				</a>
			...
			{/if}
			<a href="#{$property_dict.company_property_id}" class="property-bin-delete" title="Remove Property From Bin"><i class="icon-remove-circle"></i></a>
		</p>
	</li>
{/if}