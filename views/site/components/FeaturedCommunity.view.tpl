			...
			<div class="slide" {if $index > 0} style="display:none;"{/if}>
				<div class="relative">
					{if $community.first_pic.url}
						<img src="{$community.first_pic.url}/crop/229,180" class="img-hd" data-hd-src="{$community.first_pic.url}/crop/458,360" alt="Photo of {$community.name|clean_for_attribute}">
					{/if}
