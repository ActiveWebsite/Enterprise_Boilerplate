<ul class="breadcrumb">
	...
	{if $TOP_LEVEL_PERSISTENCE_URI}
		<li><a href="{$TOP_LEVEL_PERSISTENCE_URI}" title="{$TOP_LEVEL_PERSISTENCE_NAME}">{$TOP_LEVEL_PERSISTENCE_NAME}</a> <span class="divider">&gt;</span></li>
	{/if}
	...
	{else}
		{if $SECOND_LEVEL_PERSISTENCE_URI}
			{if $controller_obj->cms_page && $controller_obj->cms_page->uri != $TOP_LEVEL_PERSISTENCE_URI && $controller_obj->cms_page->uri != $SECOND_LEVEL_PERSISTENCE_URI}
				<li><a href="{$SECOND_LEVEL_PERSISTENCE_URI}" title="{$SECOND_LEVEL_PERSISTENCE_NAME}">{$SECOND_LEVEL_PERSISTENCE_NAME}</a> <span class="divider">&gt;</span></li>
		...
		{if $THIRD_LEVEL_PERSISTENCE_NAME}
			{if $THIRD_LEVEL_PERSISTENCE_URI}
				<li><a href="{$THIRD_LEVEL_PERSISTENCE_URI}" title="{$THIRD_LEVEL_PERSISTENCE_NAME}">{$THIRD_LEVEL_PERSISTENCE_NAME}</a> <span class="divider">&gt;</span></li>
			{else}
		...
		{if $FINAL_LEVEL_PERSISTENCE_NAME}
			{if $FINAL_LEVEL_PERSISTENCE_URI}
				<li><a href="{$FINAL_LEVEL_PERSISTENCE_URI}" title="{$FINAL_LEVEL_PERSISTENCE_NAME}">{$FINAL_LEVEL_PERSISTENCE_NAME}</a> <span class="divider">&gt;</span></li>
			{else}
