				...
				<div class="row">
					<div class="col-sm-4 col-lg-3">
						<div id="agent-header-block">
							<a href="/"><img class="img-responsive" src="{$site_owner_extended.first_pic.url}/maxwidth/166/maxheight/100" alt="{$site_owner_extended.name|clean_for_attribute}"></a>
		...
		{else}
			<div class="row">
				...
				<div class="col-sm-9 col-lg-9 site-main-content">
					...
					{else}
						{assign var=breadcrumb_path value=$view_path|replace:'/realtor':''}
