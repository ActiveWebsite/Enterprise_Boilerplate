                ...
                <td>
                    <div class="clearfix">
                        ...
                        <div class="btn-group pull-right">
                            <a class="btn btn-default fancybox" data-fancybox-type="iframe" data-fancybox-width="550" data-fancybox-height="500" href="/popup/{$ACTION_URLS.contact}/send_properties_and_searches_form/c{$category->category_id}/subject/3"><i class="icon icon-envelope"></i> Email</a>
...
{else}
    <div class="alert alert-info">
        <p>You do not have any favorite properties. <a href="{$ACTION_URLS.search}?no_favs=1" class="btn btn-sm btn-primary">Search properties to begin adding favorites</a></p>
    </div>
{/if}
