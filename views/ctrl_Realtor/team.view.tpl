	...
	<div class="row-fluid">
		...
		<div class="span4">
			<ul class="unstyled">
				...
				{/if}
				<li>
					<a href="/popup{$ACTION_URLS.contact}team/{$realtor.rebrand_code}" target="_blank" data-fancybox-type="iframe" data-fancybox-width="550" data-fancybox-height="460" rel="nofollow" class="btn fancybox">Send Us An Email</a>
				</li>
			</ul>
		</div>
		<div class="span4">
