	...
	<form action="{$form}" method="post">	
		<fieldset class="row">
			<div class="col-sm-4 col-lg-4">
				...
				<input type="text" class="col-lg-12" id="input01" name="realtor_name" placeholder="Enter Any Part of Name" value="{$smarty.request.realtor_name}">
			</div>
			{if $office_list}
				<div class="col-sm-2 col-lg-2">
					<label for="input02" class="bold">Office</label>
					<select class="col-lg-12" id="input02" name="office_id">
			...
			{if $additional_filters.spoken_languages}
				<div class="col-sm-2 col-lg-2">
					...
					<select class="col-lg-12" id="input03" name="spoken_language">
						<option value="">Any</option>
			...
			{if $additional_filters.designations}
				<div class="col-sm-2 col-lg-2">
					...
					<select class="col-lg-12" id="input04" name="designation">
						<option value="">Any</option>
